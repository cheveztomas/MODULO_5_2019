...
public class EliminarDirector extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //Inicio
            try {
                id = Integer.parseInt(request.getParameter("idDirector"));
                vlo_Retorno = vlo_LogicaDirectores.EliminarDirector(id);
                response.sendRedirect("directores.jsp?msj=" + vlo_Retorno.getVgc_Mensaje());
            } catch (Exception e) {
                response.sendRedirect("directores.jsp?msj=" + e.getMessage() + " \n Error inesperado al realizar acción.");
            }
        }
    }
